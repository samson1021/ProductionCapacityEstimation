...
namespace mechanical.Migrations
{
    ...
    [Migration("20240627055924_ProductionCapacity")]
    partial class ProductionCapacity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mechanical.Models.Entities.ProductionCapacity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<int>("MachineryInstalledPlace")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductionCaseId");

                    b.ToTable("ProductionCapacities");
                });

            modelBuilder.Entity("mechanical.Models.Entities.ProductionCapacityReestimation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("mechanical.Models.Entities.ProductionCapcityCorrection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("mechanical.Models.Entities.ProductionCase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<Guid?>("ProductionBussinessLicenceId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProductionBussinessLicenceId");

                    b.ToTable("ProductionCases");
                });

            modelBuilder.Entity("mechanical.Models.Entities.ProductionCaseAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("mechanical.Models.Entities.ProductionCaseSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("mechanical.Models.Entities.ProductionCaseTerminate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("ProductionCaseTerminates");
                });

            modelBuilder.Entity("mechanical.Models.Entities.ProductionCaseTimeLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("ProductionCaseTimeLines");
                });

            modelBuilder.Entity("mechanical.Models.Entities.ProductionReestimation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("mechanical.Models.Entities.ProductionReject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("mechanical.Models.Entities.ProductionUploadFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("mechanical.Models.Entities.ProductionCapacity", b =>
                {
                    ...
                    b.HasOne("mechanical.Models.Entities.ProductionCase", "ProductionCase")
                        .WithMany("ProductionCapacities")
                        .HasForeignKey("ProductionCaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CreatedBy");

                    b.Navigation("ProductionCase");
                });

            modelBuilder.Entity("mechanical.Models.Entities.ProductionCapacityReestimation", b =>
                {
                    b.HasOne("mechanical.Models.Entities.ProductionCapacity", "ProductionCapacity")
                        .WithMany()
            ...
            modelBuilder.Entity("mechanical.Models.Entities.ProductionCase", b =>
                {
                    ...
                    b.HasOne("mechanical.Models.Entities.ProductionUploadFile", "ProductionBussinessLicence")
                        .WithMany()
                        .HasForeignKey("ProductionBussinessLicenceId");

                    b.Navigation("CaseOriginator");

                    b.Navigation("District");

                    b.Navigation("ProductionBussinessLicence");
                });
