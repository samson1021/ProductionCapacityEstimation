...
namespace mechanical.Migrations
{
    ...
    [Migration("20250130084319_tasksharing tables fixed")]
    partial class tasksharingtablesfixed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mechanical.Models.Entities.TaskComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("mechanical.Models.Entities.TaskManagment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<Guid>("CaseOrginatorId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("SharingReason")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("mechanical.Models.Entities.TaskNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("mechanical.Models.Entities.Signatures", b =>
                {
                    b.HasOne("mechanical.Models.Entities.CreateUser", "CreateUser")
                        .WithOne("Signatures")
                        .HasForeignKey("mechanical.Models.Entities.Signatures", "CreateUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("mechanical.Models.Entities.TaskComment", b =>
                {
                    b.HasOne("mechanical.Models.Entities.CreateUser", "CommentBy")
                        .WithMany()
                        .HasForeignKey("CommentById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("mechanical.Models.Entities.TaskManagment", "Task")
                        .WithMany()
            ...
            modelBuilder.Entity("mechanical.Models.Entities.TaskManagment", b =>
                {
                    b.HasOne("mechanical.Models.Entities.CreateUser", "Assigned")
                        .WithMany()
