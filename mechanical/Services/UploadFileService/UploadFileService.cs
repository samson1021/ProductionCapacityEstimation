...
namespace mechanical.Services.UploadFileService
{
    public class UploadFileService : IUploadFileService
    {
        ...
        //public async Task<ActionResult> DownloadOrViewFile(Guid Id)
        //{
        //    var (fileBytes, fileName, mimeType, shouldDownload) = await _uploadFileService.ViewFile(Id);

        //    if (shouldDownload)
        //    {
        //        // Call the DownloadFile method for .docx or unsupported file types
        //        return await _uploadFileService.DownloadFile(Id);
        //    }
        //    else
        //    {
        //        // Display supported file types in the browser
        //        return new FileContentResult(fileBytes, mimeType) { FileDownloadName = fileName };
        //    }
        //}
        //public async Task<(byte[] , string, string)> ViewFile(Guid Id)
